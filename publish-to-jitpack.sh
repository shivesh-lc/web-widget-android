...
# LimeChat Android SDK - JitPack Publishing Script
...
CURRENT_VERSION=$(grep -o "version = '[^']*'" library/build.gradle | cut -d"'" -f2)
...
sed -i.bak "s/version = '[^']*'/version = '${NEW_VERSION}'/g" library/build.gradle
...
echo "1. Go to https://jitpack.io/#YourUsername/YourRepo"
...
echo "implementation 'com.github.YourUsername:YourRepo:${NEW_VERSION}'"
echo ""
